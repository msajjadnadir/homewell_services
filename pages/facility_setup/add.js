...
export default function add() {
  return (
    <div className="flex flex-col xl:w-[60%] w-full space-y-6 font-satoshi">
      <span className="font-bold lg:text-5xl text-3xl">Add Facility Setup</span>

      <div className="flex flex-col gap-2">
        <span>Facility Setup Name</span>
      ...
      <div className="flex flex-col gap-2">
        ...
        <Select>
          <SelectTrigger>
            <SelectValue placeholder="Select Place of Services" />
          </SelectTrigger>
          <SelectContent>
            <SelectGroup>
              {[
                ...
                "Assisted Liveing Facility", 
                "Bating Center", 
                "Community Mental Health Cener", 
                "Community Mental Health Cener", 
                "Comprehensive Inpatient Rehabiliation Facilty", 
                "Comprehensive Outpatient Rehabiliation Facilty", 
                "Custodial Care Facilty", 
                "E Unassigned", 
                "Emergency Room D Hospital", 
              ].map(
                (name) => (
                  <SelectItem key={name} value={name.toLowerCase()}>
                    {name}
      ...
      <div className="flex flex-col gap-2">
        ...
        <div className="flex lg:flex-row flex-col gap-12 mb-6">
          <div className="flex items-center space-x-6">
            ...
            <label htmlFor="terms">HHAeXchange</label>
          </div>
          <div className="flex items-center space-x-6">
            <Checkbox id="terms" className="w-6 h-6" checked />
            <label htmlFor="terms">Office Ally</label>
          </div>
          <div className="flex items-center space-x-6">
            <Checkbox id="terms" className="w-6 h-6" checked />
            <label htmlFor="terms">Waystar</label>
          </div>
          <div className="flex items-center space-x-6">
            <Checkbox id="terms" className="w-6 h-6" />
            <label htmlFor="terms">Availity</label>
          </div>
        </div>
        <div className="flex lg:flex-row flex-col gap-12">
          <div className="flex items-center space-x-6">
            <Checkbox id="terms" className="w-6 h-6" />
            <label htmlFor="terms">eMOMED</label>
          </div>
          <div className="flex items-center space-x-6">
            <Checkbox id="terms" className="w-6 h-6" />
            <label htmlFor="terms">Care Bridge</label>
          </div>
          <div className="flex items-center space-x-6">
            <Checkbox id="terms" className="w-6 h-6" />
            <label htmlFor="terms">Authenticare</label>
          </div>
          <div className="flex items-center space-x-6">
            <Checkbox id="terms" className="w-6 h-6" />
            <label htmlFor="terms">Tansshuttle</label>
          </div>
        </div>
      </div>

      <div className="flex flex-col border border-gray-200 p-6 rounded-lg space-y-4">
        <span className="font-bold text-3xl">HHAeXchange</span>
      ...
      <div className="flex flex-col border border-gray-200 p-6 rounded-lg space-y-4">
        <span className="font-bold text-3xl">Office Ally</span>
      ...
      <div className="flex flex-col gap-2">
        ...
        <span className="text-gray-500">Google Map will validate the address as you type it.</span>
      </div>
      <div className="flex flex-col gap-2">
      ...
      <div className="mt-6 lg:w-[60%] w-full">
        <span>Zip/Country/City/State</span>
