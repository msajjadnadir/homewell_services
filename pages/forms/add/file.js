            ...
            <div className="border-dashed border-2 border-gray-300 p-6 rounded-lg w-[60%] mt-10">
                ...
                <Card className="p-4">
                    <div className="flex flex-col items-center justify-center gap-4">
                        ...
                        <div className="flex items-center gap-3 border p-2 rounded-lg w-full">
                            <label
                                htmlFor="file-upload"
                                className="cursor-pointer bg-gray-100 px-4 py-2 rounded-md hover:bg-gray-300  transition-colors"
                            >
                                Choose File
                            </label>
                            <input
