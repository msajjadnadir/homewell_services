...
export default function revenue_report() {
  const [startDate, setStartDate] = useState(new Date());
  const [endDate, setEndDate] = useState(new Date());

  return (
    <div className="flex flex-col space-y-8 w-full font-satoshi">
      <span className="xl:text-5xl text-3xl font-bold">Revenue Report</span>
      ...
      <div className="flex flex-row items-center justify-between">
        <div className="flex flex-row gap-4 select-none">
          <div className="flex flex-row gap-4 select-none">
            <Button className="bg-green-200 px-10 text-green-950">Month</Button>
            <Button className="bg-green-200 px-10 text-green-950">
              Quarter
            </Button>
            <Button className="bg-green-200 px-10 text-green-950">YTD</Button>
            <Button className="bg-green-200 px-10 text-green-950">TTM</Button>
          </div>
        </div>
