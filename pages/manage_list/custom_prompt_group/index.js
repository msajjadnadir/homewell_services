...
const data = [
    {
        name: "Jane Smith",
        promptName: "Bathing, Dressing, Grooming, Hair Care",
        status: "Active",
    },
    {
        name: "Jane Smith",
...
export default function custom_prompt_group() {
    return (
        <div className="flex flex-col space-y-8 w-full font-satoshi">
            <div className="flex flex-row justify-between">
                <span className="text-3xl font-bold">Custom Prompt Group</span>
                <Button variant="default" className="px-10">
                    Add New Custom Prompt Group
                </Button>
            </div>
            <div className="grid grid-cols-4 gap-6 justify-between">
                <Input placeholder="Search Custom Prompt Group" />
            </div>
