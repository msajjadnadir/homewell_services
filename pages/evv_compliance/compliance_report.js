...
export default function compliance_report() {
    ...
    return (
        <div className="flex flex-col font-satoshi space-y-10">
            ...
            <p className="font-semibold text-2xl">GPS Location</p>
            <div className="flex flex-col mt-10 space-y-4">
                <img src="/assets/images/evv_location.png" />
            </div>

            <p className="font-semibold text-2xl">Check-in Attempt Logs</p>
            <div className="flex flex-col mt-10 space-y-4">
