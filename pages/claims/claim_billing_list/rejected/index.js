    ...
    return (
        <div className="flex flex-col space-y-8 w-full font-satoshi">
            ...
            <div className="flex flex-row gap-3">
                ...
                <Button onClick={() => router.push(paths.dashboard.claims.paid)} variant="light" className="border px-16 py-5">
                    Paid
                </Button>
                <Button onClick={() => router.push(paths.dashboard.claims.sent)} variant="light" className="border px-16 py-5">
                    Sent
                </Button>
                <Button onClick={() => router.push(paths.dashboard.claims.rejected)} variant="default" className="px-16 py-5">
                    Rejected
                </Button>
