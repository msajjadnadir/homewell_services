...
export default function AddClaimBilling() {
    const [startDate, setStartDate] = useState(new Date()); 
    const [endDate, setEndDate] = useState(new Date());

    return (
        <div className="flex flex-col space-y-6 w-full font-satoshi">
            <span className="text-3xl font-bold">Create Claim Billing</span>
            ...
            <div className="mt-4">
                <Table>
                    ...
                    <TableBody>
                        <TableRow>
                            <TableCell className="text-gray-900 font-medium">--</TableCell>
                            <TableCell className="text-gray-900 font-medium">--</TableCell>
                            <TableCell className="text-gray-900 font-medium">--</TableCell>
                            <TableCell className="text-gray-900 font-medium">--</TableCell>
                            <TableCell className="text-gray-900 font-medium">--</TableCell>
